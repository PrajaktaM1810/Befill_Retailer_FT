...
class ProductDetailsModel {
  ...
  ProductDetailsModel(
    ...
    if(retailerQuantities != null){
      _retailerQuantities = retailerQuantities;
    }
  ...
  String? get retailerQuantities => _retailerQuantities;
  ...
  ProductDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    _retailerQuantities = json['retailer_quantities'];
  }
}
